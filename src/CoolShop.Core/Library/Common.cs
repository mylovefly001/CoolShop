...
namespace CoolShop.Core.Library
{
    public static class Common
    {
        ...
        /// <returns></returns>
        public static ResultEntity Result(dynamic obj = null, StatusCodeEnum error = StatusCodeEnum.Normal)
        {
            ...
            if (obj != null && obj.GetType().ToString() != typeof(bool).FullName)
            {
                ...
                {
                    case string _:
                        if (error == StatusCodeEnum.Normal)
                        {
                            error = StatusCodeEnum.LogicErr;
                        }
                        result.Code = error;
